...
local newKeyLayout(isDark=false, isPortrait=true) =
  ...
  + std.foldl(function(acc, button)
      ...
      basicStyle.newAlphabeticButton(
        button.name,
        isDark,
        getAlphabeticButtonSize(button.name) + processAlphabeticButtonParams(button.params) + basicStyle.hintStyleSize + basicStyle.textCenterWhenShowSwipeText,
  ...
  + basicStyle.newAlphabeticButton(
    ...
    isDark,
    portraitNormalButtonSize + processAlphabeticButtonParams(commonButtons.commaButton.params) + basicStyle.hintStyleSize
  )
  + basicStyle.newAlphabeticButton(
